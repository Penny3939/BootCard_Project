...
#建立等等用來分析RFM分數的recency,frequency,monetary表格
# sql = """create or replace view RFM (customer_id,recency,frequency,monetary)
# as
# select customer_id, datediff(curdate(),date(max(transaction_date))), count(*) ,sum(total_price)
# from sales_reciepts
